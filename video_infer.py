...
weight_dir = "./finetuned_videomae_fusion_light_down"
...
model.load_state_dict(torch.load(os.path.join(weight_dir, "final_full_model.pt"), map_location=device), strict=False)
